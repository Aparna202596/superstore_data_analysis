...
for c in charts:
    print(f"    {c}")
print("\n  Run 02_Visualisation.py to regenerate charts after making changes to the code or data is complete. We can also open the charts in outputs/charts/ to view them.")
print("=" * 60)