...
warnings.filterwarnings("ignore")   # Suppress noisy model warnings
...
# STEP 4: BASELINE FORECAST (Simple Moving Average)
...
def rmse(actual, predicted):
    """Root Mean Square Error — lower is better. Same units as the data."""
    return np.sqrt(np.mean((actual - predicted) ** 2))

def mape(actual, predicted):
    """Mean Absolute Percentage Error — % error, lower is better."""
...
print("\n" + "=" * 60)
print("✓ MODULE 3 COMPLETE — Run 04_ml_modeling.py next")
print("=" * 60)